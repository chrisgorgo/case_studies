...
#                                              metric="dice", 
#                                              filename = os.path.join(results_dir, "compare within with between", "%s_%s_%s_roi_%s_dice.pdf"%(task,contrast, thr_method, roi)))
##                plot_between_within_box_plot(where=[('task_name',task), ('contrast_name',contrast), ('thr_method', thr_method), ('roi', roi)], 
##                                              metric="jaccard", 
...
#        plot_between_session_box_plot(where=[('thr_method',thr_method), ('roi', roi)], 
#                                      metric="dice", 
#                                      compare= ('task_name',["covert_verb_generation", "overt_verb_generation"]), 
#                                      filename = os.path.join(results_dir, "compare covert_verb_generation with overt_verb_generation", "%s_roi_%s_dice.pdf"%(thr_method, roi)))
